...
{
    va_list ap;
    fprintf (stderr, _("Fortran runtime error: "));
    va_start (ap, message);
...
void
    _lfortran_caf_init (int *argc __attribute__ ((unused)),
...
void
    _lfortran_caf_deregister (caf_token_t *token, caf_deregister_t type, int *stat,
...
void
    _lfortran_caf_sync_all (int *stat,
    char *errmsg __attribute__ ((unused)),
    int errmsg_len __attribute__ ((unused)))
{
...
void
    _lfortran_caf_sync_memory (int *stat,
    char *errmsg __attribute__ ((unused)),
    int errmsg_len __attribute__ ((unused)))
{
    __asm__ __volatile__ ("":::"memory");
...
void
    _lfortran_caf_sync_images (int count __attribute__ ((unused)),
...
void
    _lfortran_caf_stop_numeric(int32_t stop_code)
{
...
void
    _lfortran_caf_stop_str(const char *string, int32_t len)
{
    fputs ("STOP ", stderr);
    while (len--)
        fputc (*(string++), stderr);
...
void _lfortran_caf_fail_image (void)
{
    fputs ("IMAGE FAILED!\n", stderr);
    exit (0);
}
...
int _lfortran_caf_image_status (int image,
...
void
    _lfortran_caf_failed_images (gfc_descriptor_t *array,
    caf_team_t * team __attribute__ ((unused)),
    int * kind)
{
...
void
    _lfortran_caf_stopped_images (gfc_descriptor_t *array,
    caf_team_t * team __attribute__ ((unused)),
    int * kind)
{
    int local_kind = kind != NULL ? *kind : 4;
...
void
    _lfortran_caf_co_broadcast (gfc_descriptor_t *a __attribute__ ((unused)),
...
void
    _lfortran_caf_co_sum (gfc_descriptor_t *a __attribute__ ((unused)),
...
void
    _lfortran_caf_co_min (gfc_descriptor_t *a __attribute__ ((unused)),
    int result_image __attribute__ ((unused)),
    int *stat, char *errmsg __attribute__ ((unused)),
...
void
    _lfortran_caf_co_max (gfc_descriptor_t *a __attribute__ ((unused)),
    int result_image __attribute__ ((unused)),
    int *stat, char *errmsg __attribute__ ((unused)),
    int a_len __attribute__ ((unused)),
    int errmsg_len __attribute__ ((unused)))
...
void
    _lfortran_caf_co_reduce (gfc_descriptor_t *a __attribute__ ((unused)),
    void * (*opr) (void *, void *)
...
error:
    fprintf (stderr, _("libcaf_single RUNTIME ERROR: Cannot convert type %d kind %d to type %d kind %d\n"), src_type, src_kind, dst_type, dst_kind);
    if (stat)
        *stat = 1;
    else
        abort ();
...
void
    _lfortran_caf_get (caf_token_t token, size_t offset,
...
void
    _lfortran_caf_send (caf_token_t token, size_t offset,
    int image_index __attribute__ ((unused)),
...
void
    _lfortran_caf_sendget (caf_token_t dst_token, size_t dst_offset,
    ...
    gfc_descriptor_t *src,
    caf_vector_t *src_vector __attribute__ ((unused)),
    int dst_kind, int src_kind, bool may_require_tmp, int *stat __attribute__ ((unused)))
{
    ...
    GFC_DESCRIPTOR_DATA (src) = (void *) ((char *) MEMTOK (src_token)
        + src_offset);
    _lfortran_caf_send (dst_token, dst_offset, dst_image_index, dest, dst_vector,
    ...
    size_t num, int *stat)
{
    ...
    case CAF_REF_ARRAY:
        ...
        case CAF_ARR_REF_VECTOR:
        {
            ...
            array_offset_src = 0;
            dst_index[dst_dim] = 0;
            for (idx = 0; idx < ref->u.a.dim[src_dim].v.nvec; ++idx)
            {
...
void
    _lfortran_caf_get_by_ref (caf_token_t token,
    int image_index __attribute__ ((unused)),
    ...
    size_t num, size_t size, int *stat)
{
        ...
        case CAF_REF_COMPONENT:
            if (ref->u.c.caf_token_offset > 0)
            {
                if (*(void**)(ds + ref->u.c.offset) == NULL)
                {
                    ...
                    scalar.  */
                    _lfortran_caf_register (ref->item_size,
    ...
    case CAF_REF_COMPONENT:
        if (ref->u.c.caf_token_offset > 0)
        {
            if (*(void**)(ds + ref->u.c.offset) == NULL)
            {
                ...
                _lfortran_caf_register (size * ref->item_size,
                    CAF_REGTYPE_COARRAY_ALLOC,
                    ds + ref->u.c.caf_token_offset,
                    dst, stat, NULL, 0);
                /* In case of an error in allocation return.  When stat is
    ...
    case CAF_REF_ARRAY:
        ...
        case CAF_ARR_REF_VECTOR:
        {
            ...
            array_offset_dst = 0;
            src_index[src_dim] = 0;
            for (idx = 0; idx < ref->u.a.dim[dst_dim].v.nvec;
                ++idx)
            {
#define KINDCASE(kind, type) case kind: \
...
void
    _lfortran_caf_send_by_ref (caf_token_t token,
    int image_index __attribute__ ((unused)),
...
void
    _lfortran_caf_sendget_by_ref (caf_token_t dst_token, int dst_image_index,
    ...
    int *src_stat)
{
    ...
    _lfortran_caf_get_by_ref (src_token, src_image_index, &temp, src_refs,
    ...
    _lfortran_caf_send_by_ref (dst_token, dst_image_index, &temp, dst_refs,
        dst_kind, src_kind, may_require_tmp, true,
        dst_stat);
...
void
    _lfortran_caf_atomic_define (caf_token_t token, size_t offset,
    int image_index __attribute__ ((unused)),
    void *value, int *stat,
...
void
    _lfortran_caf_atomic_ref (caf_token_t token, size_t offset,
    int image_index __attribute__ ((unused)),
    void *value, int *stat,
    int type __attribute__ ((unused)), int kind)
{
...
void
    _lfortran_caf_atomic_cas (caf_token_t token, size_t offset,
    int image_index __attribute__ ((unused)),
...
void
    _lfortran_caf_atomic_op (int op, caf_token_t token, size_t offset,
    int image_index __attribute__ ((unused)),
...
void
    _lfortran_caf_event_post (caf_token_t token, size_t index, 
    int image_index __attribute__ ((unused)), 
    int *stat, char *errmsg __attribute__ ((unused)), 
    int errmsg_len __attribute__ ((unused)))
{
...
void
    _lfortran_caf_event_wait (caf_token_t token, size_t index, 
...
void
    _lfortran_caf_event_query (caf_token_t token, size_t index, 
    int image_index __attribute__ ((unused)), 
    int *count, int *stat)
{
    uint32_t *event = (uint32_t *) ((char *) MEMTOK (token) + index
...
void
    _lfortran_caf_lock (caf_token_t token, size_t index,
    int image_index __attribute__ ((unused)),
    int *aquired_lock, int *stat, char *errmsg, int errmsg_len)
{
    const char *msg = _("Already locked");
    ...
    _lfortran_caf_error_stop_str (msg, (int32_t) strlen (msg));
}


void
    _lfortran_caf_unlock (caf_token_t token, size_t index,
    int image_index __attribute__ ((unused)),
    int *stat, char *errmsg, int errmsg_len)
{
    const char *msg = _("Variable is not locked");
    bool *lock = &((bool *) MEMTOK (token))[index];
...
int
    _lfortran_caf_is_present (caf_token_t token,
    int image_index __attribute__ ((unused)),
