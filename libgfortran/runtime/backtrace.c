...
show_backtrace (bool in_signal_handler)
{
  ...
  state.error = 0;
  state.in_signal_handler = in_signal_handler;

#if defined(HAVE_FORK) && defined(HAVE_EXECVE) && defined(HAVE_WAIT) && defined(HAVE_PIPE) && defined(HAVE_DUP2) && defined(HAVE_CLOSE)
