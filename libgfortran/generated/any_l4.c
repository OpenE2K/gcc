	...
	const index_type * const restrict pdim)
{
  ...
  if (retarray->base_addr == NULL)
	...
	runtime_error ("rank of return array incorrect in ANY intrinsic: is %ld, should be %ld",
      ...
      if (unlikely (compile_options.bounds_check))
	{
	  for (n=0; n < rank; n++)
		...
		runtime_error ("Incorrect extent in return value of ANY intrinsic in dimension %d: is %ld, should be %ld",
